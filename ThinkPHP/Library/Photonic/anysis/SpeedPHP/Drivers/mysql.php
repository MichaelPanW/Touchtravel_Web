...
class db_mysql {
	...
	{
		//$linkfunction = ( TRUE == $dbConfig['persistent'] ) ? 'mysql_pconnect' : 'mysqli_connect';
		...
		$this->conn = mysqli_connect($dbConfig['host'], $dbConfig['login'], $dbConfig['password'], $dbConfig['database']);
