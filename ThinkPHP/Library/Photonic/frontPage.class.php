...
class frontPage{
    ...
    protected $rollPage   ;
	// 分頁顯示定制
    protected $config  =	array('header'=>'條記錄','prev'=>'上一頁','next'=>'下一頁','first'=>'','last'=>'','theme'=>'%first% %upPage% %linkPage% %downPage% %end%');
    ...
    public function show() {
        ...
        if($this->nowPage!=1)$pageStr="<a href='$url&?&p=1'>第一頁</a>".$pageStr;
        if($this->nowPage!=$this->totalPages)$pageStr=$pageStr."<a href='$url&?&p=$this->totalPages'>最後一頁</a>";
		
		return 	$pageStr." 分 $this->totalPages 頁 共 $this->totalRows 項";
    }
