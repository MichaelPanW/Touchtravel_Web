	...
	********************************************************************************************/
	...
	(function(d, s, id) {
	    ...
	    js.id = id;
	    js.src = "//connect.facebook.net/zh_TW/sdk.js#xfbml=1&version=v2.7&appId=" + appId;
	...
	********************************************************************************************/
	...
	function show_fb_fans(id, width, height, href) {
	    ...
	    if (href == "") href = "https://www.facebook.com/";
	    if (width == "" || width < 180 || width > 500) width = 340;
	    if (height == "" || height < 70) height = 500;
